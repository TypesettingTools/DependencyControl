...
->
...

  {
    ...
    selectTextExtentsBackend_prefersCoreTextForTheMacContract: (ut) ->
      measure, name = shims.selectTextExtentsBackend shims.TextExtentsMetricMode.AegisubMac
      if coretext.isAvailable
        ut\assertEquals name, "CoreText/AegisubMac"
        ut\assertType measure, "function"
      elseif freetype.isAvailable
        ut\assertEquals name, "FreeType/AegisubMac"
        ut\assertType measure, "function"
      else
        ut\assertNil measure
