...
---@class Ass
---@field defaultStyle AegisubStyle The values a style starts out as, as Aegisub's AssStyle does. Read-only; copy it with `createStyle` rather than mutating it.
Ass = {
