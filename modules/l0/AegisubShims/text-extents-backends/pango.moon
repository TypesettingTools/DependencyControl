...
-- eager-load all used Pango symbols so we error out early (and on test runs w/ no Pango library) when an undeclared one is used
{:pango_font_description_free, :pango_font_description_new, :pango_font_description_set_family,
  :pango_font_description_set_size, :pango_font_description_set_style,
  :pango_font_description_set_weight, :pango_font_map_create_context, :pango_layout_get_iter,
  :pango_layout_get_pixel_size, :pango_layout_iter_free, :pango_layout_iter_get_baseline,
  :pango_layout_new, :pango_layout_set_font_description, :pango_layout_set_text} = pango
{:pango_cairo_context_set_resolution, :pango_cairo_font_map_get_default} = pangocairo
...
buildLayout = (resolution) ->
  ...
  return {
    context: ffi.gc context, g_object_unref
    layout: ffi.gc layout, g_object_unref
  }
...
acquireDescription = (style) ->
  ...
  ffi.gc description, pango_font_description_free

  pango_font_description_set_family description, family
  pango_font_description_set_weight description, weight
  pango_font_description_set_style description, slant
...
measureRun = (layout, description, text) ->
  ...
  pango_layout_set_text layout, text, #text
  pango_layout_get_pixel_size layout, pixelSizeOut, pixelSizeOut + 1
...
createBackend = (options) ->
  ...
  return (style, text) ->
    ...
    return textExtents.applyStyleScale style, width, height, descent, 0
...
---
---It exists to compare the default backends against, never to replace them. The Windows numbers are
---what libass renders by, and Pango cannot produce them, since it never exposes the OS/2 Windows cell
---metrics; what it can produce is the Linux numbers with nothing missing.
---
