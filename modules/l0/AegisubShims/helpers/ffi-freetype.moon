-- Values are transcribed from FreeType 2.14.3's freetype.h and tttables.h.
...
freetypeBinding = ffiBinding.bind {
  ...
  declarations: [[
    ...
    typedef struct {
      ...
      unsigned long ulCodePageRange1; unsigned long ulCodePageRange2;
      short sxHeight; short sCapHeight;
      unsigned short usDefaultChar; unsigned short usBreakChar; unsigned short usMaxContext;
      unsigned short usLowerOpticalPointSize; unsigned short usUpperOpticalPointSize;
    } TtOs2;
...
LoadFlag = Flags "FreeTypeLoadFlag", {
  Default: 0
  NoScale: 0x1
  NoHinting: 0x2
  Render: 0x4
...
FaceFlag = Flags "FreeTypeFaceFlag", {
  Scalable: 0x1
  FixedSizes: 0x2
  FixedWidth: 0x4
  Sfnt: 0x8
