...
function ASSFoundation:new()
    local tagMap = {
        ...
        clip_rect = {overrideName="\\clip", friendlyName="\\clip (Rectangle)", type=ASSClipRect, global=false, 
                     pattern="\\clip%(([%-%d%.]+),([%-%d%.]+),([%-%d%.]+),([%-%d%.]+)%)", format="\\clip(%.2N,%.2N,%.2N,%.2N)", props={transformable=true}}, 
        iclip_rect = {overrideName="\\iclip", friendlyName="\\iclip (Rectangle)", type=ASSClipRect, props={inverse=true}, global=false, 
                      pattern="\\iclip%(([%-%d%.]+),([%-%d%.]+),([%-%d%.]+),([%-%d%.]+)%)", format="\\iclip(%.2N,%.2N,%.2N,%.2N)", default={0,0,0,0}, props={transformable=true, global=false}}, 
        drawing = {overrideName="\\p", type=ASSNumber, props={positive=true, precision=0}, pattern="\\p(%d+)", format="\\p%d", default={0}}, 
        blur_edges = {overrideName="\\be", type=ASSNumber, props={positive=true}, pattern="\\be([%d%.]+)", format="\\be%.2N", default={0}, props={transformable=true}}, 
        blur = {overrideName="\\blur", type=ASSNumber, props={positive=true}, pattern="\\blur([%d%.]+)", format="\\blur%.2N", default={0}, props={transformable=true}}, 
        ...
        position = {overrideName="\\pos", type=ASSPoint, pattern="\\pos%(([%-%d%.]+),([%-%d%.]+)%)", format="\\pos(%.3N,%.3N)", global=true},
        ...
        origin = {overrideName="\\org", type=ASSPoint, pattern="\\org%(([%-%d%.]+),([%-%d%.]+)%)", format="\\org(%.3N,%.3N)", global=true},
